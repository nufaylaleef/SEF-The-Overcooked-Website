...
<body>
    <header>
        ...
        <nav>
            <ul class="navigation_link">
                ...
                <li><a href="signin_uppage.html">Sign In</a></li>
            </ul>
        </nav>
    ...
    <main class="recipe-details">
        <?php
            ...
            $sql = "SELECT users.username, posted_recipe.recipeName, posted_recipe.picture, posted_recipe.chefId, 
                           posted_recipe.tag, posted_recipe.note, posted_recipe.details, posted_recipe.ingredients, 
                           posted_recipe.instruction, users.profile_pic 
                    FROM posted_recipe 
            ...
            if ($row = $result->fetch_assoc()) {
                ...
                echo "<img src='{$row['profile_pic']}' alt='Chef Profile'>";
        ...
        <section class="recipe-comments">
            ...
            <?php
                $sql = "SELECT users.profile_pic, users.username, comment.commentContent, comment.commentDatetime 
                        ...
                        ORDER BY comment.commentDatetime DESC";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<p class='comment-date'>{$row['commentDatetime']}</p>";
        ...
        <section class="comment-prompt">
            <p>Want to leave a comment? <a href="signin_uppage.html">Sign in</a> to join the conversation!</p>
        </section>
    </main>
</body>
