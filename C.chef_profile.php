...
$chefId = $userId; // For chef-specific features
    ...
    <header>
        ...
        <nav>
            <ul class="navigation_link">
                ...
                <li><a href="C.chef_profile.php?userId=<?php echo $_SESSION['userId']; ?>">Profile</a></li>
            </ul>
        </nav>
    </header>
    <main class="page">
        <div class="profile-container">
            ...
            <div class="chef-buttons">
                <a href="C.recipe_form.php?chefId=<?php echo $chefId; ?>" class="chef-button">Submit Recipe</a>
                <a href="C.chef_pending_recipe.php?chefId=<?php echo $chefId; ?>" class="chef-button">View Submitted Recipes</a>
                <a href="C.chef_own_recipe.php?chefId=<?php echo $chefId; ?>" class="chef-button">View My Recipes</a>
            </div>
